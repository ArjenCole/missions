...
namespace missions
{
    ...
    4. 用户使用须知
        ...
        4.8 隐私权保护：为了更好地改进软件和服务，在用户关闭本软件时，本软件可能会向作者报告软件所在计算机的唯一标识，具体报告方法为向服务器发送相关信息，此信息将被用于记录软件操作以便重现可能出现的程序崩溃现象，帮助更好的改善程序。作者不会将此数据与用户的个人身份信息相关联。
    5.免责与责任限制
    ...
    7. 其他条款
        ...
        private void FmAbout_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Escape:
